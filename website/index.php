...
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('<?php echo base_url("images/icon/logo-revisi.png");?>');background-position: center center;">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-xl-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		  	<!-- <b style="text-align:right">
            	<h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">
				<span>Merajut<br>Nusantara<br>III 2020</span></h1>
			</b> -->
