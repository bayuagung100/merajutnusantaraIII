	...
	<script type="text/javascript">
		$(function(){
			$('#modal-<?php echo $nama; ?>').on('hidden.bs.modal', function (e) {
				...
				if(url != "") $('.tampil-<?php echo $nama; ?>').html('<img src="../images/source/'+url+'" width="150" style="margin-bottom: 10px">');
			})
		});
	</script>
<?php
	echo'<div class="form-group imagepicker">
		...
		if($nilai != "") echo'<img src="../images/source/'.$nilai.'" width="150" style="margin-bottom: 10px">';
	echo'	</div>
...
function buat_imagepicker_pendaftar($label, $nama, $nilai, $lebar='4'){
	?>
		<script type="text/javascript">
			$(function(){
				$('#modal-<?php echo $nama; ?>').on('hidden.bs.modal', function (e) {
					var url = $('#<?php echo $nama; ?>').val();
					if(url != "") $('.tampil-<?php echo $nama; ?>').html('<img src="../images/pendaftar/'+url+'" width="150" style="margin-bottom: 10px">');
				})
			});
		</script>
	<?php
		echo'<div class="form-group imagepicker">
				...
				<div class="col-sm-'.$lebar.'">
				<div class="tampil-'.$nama.'">';
			if($nilai != "") echo'<img src="../images/pendaftar/'.$nilai.'" width="150" style="margin-bottom: 10px">';
		echo'	</div>
				<div class="input-group">
				  <input type="text" class="form-control input-'.$nama.'" id="'.$nama.'" name="'.$nama.'" value="'.$nilai.'" readonly>
				  <a data-toggle="modal" data-target="#modal-'.$nama.'" class="input-group-addon btn btn-success pilih-'.$nama.'">...</a>
